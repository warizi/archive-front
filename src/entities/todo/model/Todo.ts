...
export const todoSchema = z.object({
  ...
  category: categorySchema.required({ id: true }).optional().nullable(),
  startDate: YMD.optional(),
  endDate: YMD.optional(),
  importance: z.enum([IMPORTANCE.low, IMPORTANCE.medium, IMPORTANCE.high, IMPORTANCE.none]).optional().nullable(),
